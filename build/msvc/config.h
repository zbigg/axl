...
* File:		config.h
*
* Id:		$Id: config.h 1.3 04/02/24 01:39:32+01:00 zbigg@marl.(none) $
*
* Config header for Microsoft Visual C++.
*/
...
/* define if gd library is used */
#undef AXL_WITH_GD

/* define if MySQL library is used */
#undef AXL_WITH_MYSQL

/* define if PostgreSQL library is used */
